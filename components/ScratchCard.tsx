...
function FrownIcon() {
  return (
    <svg width="40" height="40" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round" className="mx-auto" aria-hidden="true">
...
function ConfettiIcon() {
  return (
    <svg width="40" height="40" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round" className="mx-auto text-[var(--brand)]" aria-hidden="true">
...
export default function ScratchCard({ onResult, disabled }: Props) {
  ...
  useEffect(() => {
    ...
    ctx.font = "bold 20px sans-serif"; ctx.fillText("SCRATCH", WIDTH / 2, HEIGHT / 2);
          ...
          <div className="sc-main">
            ...
            <div className="sc-prize-layer">
              <div className="sc-prize-inner">
                {prize?.type === "no_prize" ? (
                  <>
                    <span className="sc-prize-emoji"><FrownIcon /></span>
                    <span className="sc-prize-text">{prize?.label ?? "Try Again"}</span>
                  </>
                ) : (
                  <>
                    <span className="sc-prize-emoji sc-prize-emoji--win"><ConfettiIcon /></span>
