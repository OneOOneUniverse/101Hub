...
export default async function MemoryMatchPage() {
  ...
  return (
    <main className="min-h-screen bg-gradient-to-b from-[#0d0921] to-[#1a0f35] px-4 py-10">
      <div className="max-w-lg mx-auto">
        ...
        <div className="text-center mb-6">
          ...
          <h1 className="text-2xl font-black text-white">Memory Match</h1>
          <p className="text-sm text-white/50 mt-1">Flip cards and match all pairs to earn 75 points!</p>
        </div>
